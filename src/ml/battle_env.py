...
OBS_DIM = 78
TEAM_SIZE = 6
# OBS_DIM_DOUBLES lives in battle_env_doubles.py (re-exported at the bottom of
# this file for backward compatibility) — this file only handles singles.
N_MOVES = 4
...
# Re-exported for backward compatibility: doubles-format observation building
# and the doubles Gym env live in battle_env_doubles.py (extracted to keep
# this file under the 800-line guideline), but existing call sites still
# import them from here.
from src.ml.battle_env_doubles import (  # noqa: E402, F401
    OBS_DIM_DOUBLES,
    BattleDoubleEnv,
